      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
          ...
          <div className={`rounded-lg shadow-md p-6 text-center hover:shadow-xl transition ${
            ...
            <h4 className={`text-base md:text-base font-medium mb-2 ${darkMode ? "text-white" : "text-gray-800"}`}>
              React JS
            </h4>
          ...
          <div className={`rounded-lg shadow-md p-6 text-center hover:shadow-xl transition ${
            ...
            <h4 className={`text-lg md:text-base font-medium mb-2 ${darkMode ? "text-white" : "text-gray-800"}`}>
              JavaScript
            </h4>
            <p className={`text-base md:text-base leading-normal font-normal ${darkMode ? "text-white" : "text-gray-600"}`}>
