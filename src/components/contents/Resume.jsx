            ...
            <div className='border-l-4 border-blue-500 pl-4 space-y-1'>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mt-2">
                  <button className="bg-blue-500 text-white text-sm font-medium py-2 px-2 rounded-lg shadow border border-blue-500 hover:bg-blue-600 transition duration-300 ease-in-out">
                    React Js
                  </button>

                  <button className="bg-green-500 text-white text-sm font-medium py-2 px-2 rounded-lg shadow border border-green-500 hover:bg-green-600 transition duration-300 ease-in-out">
                    Redux ToolKit
                  </button>

                  <button className="bg-yellow-400 text-white text-sm font-medium py-2 px-4 rounded-lg shadow border border-yellow-400 hover:bg-yellow-500 transition duration-300 ease-in-out">
                    Material-UI
                  </button>

                  <button className="bg-cyan-500 text-white text-sm font-medium py-2 px-2 rounded-lg shadow border border-cyan-500 hover:bg-cyan-600 transition duration-300 ease-in-out">
                    OpenAI API
                  </button>
                  ...
                  <button className="bg-yellow-400 text-white text-sm font-medium py-2 px-2 rounded-lg shadow border border-yellow-400 hover:bg-yellow-500 transition duration-300 ease-in-out">
                    nest.js
                  </button>
                </div>
